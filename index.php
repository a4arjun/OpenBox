  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <h1 class="header center  text-lighten-2">OpenBox</h1>
        <div class="row center">
          <h5 class="header col s12 light">A new and innovative way to save your files</h5>
        </div>
        <div class="row center">
          <a href="login.php" class="btn-large waves-effect waves-light red">Get Started</a>
        </div>
        <br><br>
